...
//			PCF8576_Point(ucUPdatapos[3], ucUPdatacode[3]);	
//			//PCF8576_Point(ucUPpointpos[8],ucUPpointcode[8]);
//			PCF8576_Point(ucUPdatapos[4], ucUPdatacode[4]);
//			DIS_LEL();
//			delay_ms(1000);
//			PCF8576_Disp(0x00, none_disp, 20);
//			LED_Warn(OFF);
//			PCF8576_Point(ucUPdatapos[0], ucUPdatacode[1]);
//			PCF8576_Point(ucUPdatapos[1], ucUPdatacode[1]);	
//			PCF8576_Point(ucUPdatapos[2], ucUPdatacode[7]);	
//			PCF8576_Point(ucUPdatapos[3], ucUPdatacode[0]);
//			PCF8576_Point(ucUPdatapos[4], ucUPdatacode[0]);	
//			DIS_PPM();
//			delay_ms(1000);
...
//			PCF8576_Point(ucUPdatapos[3], ucUPdatacode[3]);	
//			//PCF8576_Point(ucUPpointpos[8],ucUPpointcode[8]);
//			PCF8576_Point(ucUPdatapos[4], ucUPdatacode[9]);
//			DIS_LEL();
//			delay_ms(1000);
//			PCF8576_Disp(0x00, none_disp, 20);
//			LED_Warn(OFF);
//			PCF8576_Point(ucUPdatapos[0], ucUPdatacode[1]);
//			PCF8576_Point(ucUPdatapos[1], ucUPdatacode[1]);	
//			PCF8576_Point(ucUPdatapos[2], ucUPdatacode[9]);	
//			PCF8576_Point(ucUPdatapos[3], ucUPdatacode[5]);
//			PCF8576_Point(ucUPdatapos[4], ucUPdatacode[0]);	
//			DIS_PPM();
//			delay_ms(1000);
//			
...
//			PCF8576_Point(ucUPdatapos[3], ucUPdatacode[3]);	
//			//PCF8576_Point(ucUPpointpos[8],ucUPpointcode[8]);
//			PCF8576_Point(ucUPdatapos[4], ucUPdatacode[7]);
//			DIS_LEL();
//			delay_ms(1000);
//			PCF8576_Disp(0x00, none_disp, 20);
//			LED_Warn(OFF);
