...
#define LCD_SCL_CLR()	GPIO_ResetBits(GPIOB,GPIO_Pin_7)
#define LCD_SCL_SET()	GPIO_SetBits(GPIOB,GPIO_Pin_7)

#define LCD_SDA_CLR()	GPIO_ResetBits(GPIOB,GPIO_Pin_6)
#define LCD_SDA_SET()	GPIO_SetBits(GPIOB,GPIO_Pin_6)

#define LCD_RST_CLR()	GPIO_ResetBits(GPIOB,GPIO_Pin_5)
